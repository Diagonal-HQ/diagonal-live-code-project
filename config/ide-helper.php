...
return [
    ...
    */
    ...
    'magic' => [
        Builder::class => [
            'whereHasMorph' => 'whereHasMorph(string $relation, array|string $types, \Closure|null $callback = null, string $operator = ">=", int $count = 1): \Illuminate\Database\Eloquent\Builder',
            'where' => 'where($column, $operator = null, $value = null, $boolean = "and"): \Illuminate\Database\Eloquent\Builder',
            'orWhereHasMorph' => 'orWhereHasMorph(string $relation, array|string $types, \Closure|null $callback = null): \Illuminate\Database\Eloquent\Builder',
        ],
        \Illuminate\Database\Query\Builder::class => [
            'whereHasMorph' => 'whereHasMorph(string $relation, array|string $types, \Closure|null $callback = null, string $operator = ">=", int $count = 1): \Illuminate\Database\Query\Builder',
            'where' => 'where($column, $operator = null, $value = null, $boolean = "and"): \Illuminate\Database\Query\Builder',
            'orWhereHasMorph' => 'orWhereHasMorph(string $relation, array|string $types, \Closure|null $callback = null): \Illuminate\Database\Query\Builder',
        ],
    ],
